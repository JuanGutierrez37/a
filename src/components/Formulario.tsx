...
import { Button, Modal, SafeAreaView,StyleSheet,Text, TextInput,View, ScrollView,Pressable, Alert } from 'react-native';
import DatePicker from 'react-native-date-picker';


const Formulario = ({modalVisible,nuevaCitaHandler,setPacientes, pacientes} : {modalVisible: boolean,nuevaCitaHandler: () => void,setPacientes: (pacientes: any[]) => void,pacientes: any[]}) => {
